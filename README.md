...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/bQi5n6yeRg)
...
```sh
npx nx serve aws-amplify-cognito
```

To create a production bundle:

```sh
npx nx build aws-amplify-cognito
```

To see all available targets to run for a project, run:

```sh
npx nx show project aws-amplify-cognito
```
